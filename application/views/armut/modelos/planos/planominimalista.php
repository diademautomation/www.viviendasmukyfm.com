                ...
                <div class="col-md-6">
                    <div class="blog-item bg-light rounded overflow-hidden">
                        <div class="blog-img position-relative overflow-hidden">
                            <img class="img-fluid" src="<?php echo base_url();?>assets/img/casas/Minimalista/<?php echo $minimalista->id;?>/plano1.webp" alt="plano vivienda minimalsta">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-5 wow slideInUp">
                        ...
                        <div class="link-animated d-flex flex-column justify-content-start">
                            ...
                            <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="#"><i class="bi bi-arrow-right me-2"></i>Minimalista</a>
