            ...
            <!--<div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">-->    
                <div class="col-md-6 wow slideInUp">
                        ...
                        <div class="blog-img position-relative overflow-hidden">
                            ...
                            <img class="img-fluid2" src="<?php echo base_url();?>assets/img/casas/Americana/planos/<?php echo $americana->id;?>/plano1.webp" alt="plano vivienda americana">
            ...
            <?php } ?>    
                        ...
                        <div class="col-12 wow slideInUp">
                            <nav aria-label="Page navigation">
                              <ul class="pagination pagination-lg m-0 ulnone">
                                ...
                                <li class="page-item"><a class="page-link" href="<?php echo base_url();?>modelos/planoamericana2">2</a></li>
                                <li class="page-item">                                                 
                                  <a class="page-link rounded-0" href="<?php echo base_url();?>modelos/planoamericana2" aria-label="Next">
