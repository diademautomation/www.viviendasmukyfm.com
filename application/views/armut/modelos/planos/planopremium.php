    ...
    <div class="container-fluid py-5 wow fadeInUp">
        ...
        <div class="text-center pb-3 mb-5 mx-auto" style="max-width: 600px;">
            ...
            <div class="row g-5">
                ...
                <!--<div class="col-md-6 wow slideInUp" data-wow-delay="0.0s">-->
                <div class="col-md-6 wow slideInUp">
                        <div class="blog-item bg-light rounded overflow-hidden">
                        <div class="blog-img position-relative overflow-hidden">
                            <img class="img-fluid" src="<?php echo base_url();?>assets/img/casas/Premium/<?php echo $premium->id;?>/plano1.webp" alt="plano vivienda premium">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-5 wow slideInUp">
                        ...
                        <div class="link-animated d-flex flex-column justify-content-start">
                            <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="<?php echo base_url();?>modelos/planoamericana"><i class="bi bi-arrow-right me-2"></i>Americana</a>
                            ...
                            <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="#"><i class="bi bi-arrow-right me-2"></i>Premium</a>
