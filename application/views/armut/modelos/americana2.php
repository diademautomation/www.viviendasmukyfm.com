            ...
            <div class="col-12 wow slideInUp ">
                            <nav aria-label="Page navigation">
                              <ul class="pagination pagination-lg m-0">
                                <li class="page-item">
                                  <a class="page-link rounded-0" href="<?php echo base_url();?>modelos/americana" aria-label="Previous">
                                    <span aria-hidden="true"><i class="bi bi-arrow-left"></i></span>
                                  </a>
                                </li>
                                <li class="page-item "><a class="page-link" href="<?php echo base_url();?>modelos/americana">1</a></li>
